import svgPaths from "./svg-7jh1qw4fhc";
...
function Frame71349476() {
  return (
    <div className="absolute bg-[#e0e0e0] box-border content-stretch flex flex-row gap-4 items-center justify-start left-0 pl-[68px] pr-4 py-4 rounded-2xl top-[15px]">
      <div
        aria-hidden="true"
...
export default function Frame71349477() {
  return (
    <div className="relative size-full">
      <Frame71349476 />
      <div
        className="absolute bg-center bg-cover bg-no-repeat h-[98px] left-[11px] top-0 w-[45px]"
        data-name="2000472 1"
